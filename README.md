...
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/{owner}/{gauge-web-app-steps}/badge)](https://securityscorecards.dev/viewer/?uri=github.com/{owner}/{gauge-web-app-steps})
