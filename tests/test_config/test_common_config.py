...
class TestCommonConfig(unittest.TestCase):
    ...
    def test_get_operating_system(self):
        with patch.dict(os.environ, {"driver_operating_system": "win"}):
            ...
            assert OperatingSystem.WINDOWS == result
